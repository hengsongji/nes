...
JNIEXPORT jboolean JNICALL Java_com_falcon_nester_NesSimu_Initialize(
		JNIEnv * pEnv,
		jobject pThis,
		jobject objBitmap)
{
...
JNIEXPORT void JNICALL Java_com_falcon_nester_NesSimu_destroy(
		JNIEnv * pEnv,
		jobject pThis,
		jboolean bSaveRam)
{
...
JNIEXPORT jboolean JNICALL Java_com_falcon_nester_NesSimu_loadGame(
		JNIEnv * pEnv,
		jobject pThis,
		jstring strFilename,
		jboolean bLoadRam)
...
JNIEXPORT jboolean JNICALL Java_com_falcon_nester_NesSimu_isRamExisted(
		JNIEnv * pEnv,
		jobject pThis,
		jstring strFilename)
{
...
JNIEXPORT jboolean JNICALL Java_com_falcon_nester_NesSimu_loadSRAM(
		JNIEnv * pEnv,
		jobject pThis,
		jstring filename)
{
...
JNIEXPORT jboolean JNICALL Java_com_falcon_nester_NesSimu_saveSRAM(
		JNIEnv * pEnv,
		jobject pThis,
		jstring filename)
{
...
JNIEXPORT jbyteArray JNICALL Java_com_falcon_nester_NesSimu_getSaveRAM(
		JNIEnv *pEnv,
		jobject pThis)
{
...
JNIEXPORT void JNICALL Java_com_falcon_nester_NesSimu_reset(
		JNIEnv * pEnv,
		jobject pThis)
{
...
JNIEXPORT void JNICALL Java_com_falcon_nester_NesSimu_setMute(
		JNIEnv * pEnv,
		jobject pThis,
		jboolean bMute)
{
...
JNIEXPORT void JNICALL Java_com_falcon_nester_NesSimu_setVolume(
		JNIEnv * pEnv,
		jobject pThis,
		jfloat vol)
{
...
JNIEXPORT void JNICALL Java_com_falcon_nester_NesSimu_stop(
		JNIEnv * pEnv,
		jobject pThis,
		jboolean bSaveRAM)
{
...
JNIEXPORT void JNICALL Java_com_falcon_nester_NesSimu_pause(
		JNIEnv * pEnv,
		jobject pThis)
{
...
JNIEXPORT void JNICALL Java_com_falcon_nester_NesSimu_resume(
		JNIEnv * pEnv,
		jobject pThis)
{
...
JNIEXPORT jint JNICALL Java_com_falcon_nester_NesSimu_getWidth(
		JNIEnv * pEnv,
		jobject pThis)
{
	return NES_DISP_WIDTH;
}
JNIEXPORT jint JNICALL Java_com_falcon_nester_NesSimu_getHeight(
		JNIEnv * pEnv,
		jobject pThis)
{
...
JNIEXPORT void JNICALL Java_com_falcon_nester_NesSimu_setPad1Input(
		JNIEnv * pEnv,
		jobject pThis,
		jint padMask,
		jint padValue)
...
JNIEXPORT void JNICALL Java_com_falcon_nester_NesSimu_setPad2Input(
		JNIEnv * pEnv,
		jobject pThis,
		jint padMask,
		jint padValue)
...
JNIEXPORT static jstring JNICALL Java_com_falcon_nester_NesSimu_getDebugInfo(
		JNIEnv* pEnv,
		jobject clazz)
{
