...
#include "../h/InfoNES.h"
#include "../h/InfoNES_System.h"
#include "../h/InfoNES_Mapper.h"
#ifdef NES_SOUND_SUPPORT
#include "../h/InfoNES_pAPU.h"
#endif
#include "../h/K6502.h"
...
// r8,g8,b8 : 0~255       spr1 : [0,1]
#define RGB555( r8, g8, b8 )	((((r8)<<7)&0x7C00) | (((g8)<<2)&0x03E0)|(((b8)>>3)&0x001F))
#define RGB565( r8, g8, b8 )	((((r8)<<8)&0xF800) | (((g8)<<3)&0x07C0)|(((b8)>>3)&0x001F))
//#define RGB888( r8, g8, b8 )	((((r8)<<16)&0xff0000) | (((g8)<<8)&0x00ff00)|(((b8))&0x0000ff))
#define RGB888( r8, g8, b8 )	((((b8)<<16)&0xff0000) | (((g8)<<8)&0x00ff00)|(((r8))&0x0000ff))
#define RGBA8888( r8, g8, b8 )	( 0xff000000 | (((b8)<<16)&0xff0000) | (((g8)<<8)&0x00ff00)|(((r8))&0x0000ff))
// Palette data
...
#else
	RGB_TYPE(0x70, 0x70, 0x70), RGB_TYPE(0x20, 0x18, 0x88), RGB_TYPE(0x00, 0x00, 0xA8), RGB_TYPE(0x40, 0x00, 0x98), RGB_TYPE(0x88, 0x00, 0x70), RGB_TYPE(0xA8, 0x00, 0x10), RGB_TYPE(0xA0, 0x00, 0x00), RGB_TYPE(0x78, 0x08, 0x00), 
	RGB_TYPE(0x40, 0x28, 0x00), RGB_TYPE(0x00, 0x40, 0x00), RGB_TYPE(0x00, 0x50, 0x00), RGB_TYPE(0x00, 0x38, 0x10), RGB_TYPE(0x18, 0x38, 0x58), RGB_TYPE(0x00, 0x00, 0x00), RGB_TYPE(0x00, 0x00, 0x00), RGB_TYPE(0x00, 0x00, 0x00), 
	RGB_TYPE(0xB8, 0xB8, 0xB8), RGB_TYPE(0x00, 0x70, 0xE8), RGB_TYPE(0x20, 0x38, 0xE8), RGB_TYPE(0x80, 0x00, 0xF0), RGB_TYPE(0xB8, 0x00, 0xB8), RGB_TYPE(0xE0, 0x00, 0x58), RGB_TYPE(0xD8, 0x28, 0x00), RGB_TYPE(0xC8, 0x48, 0x08), 
	RGB_TYPE(0x88, 0x70, 0x00), RGB_TYPE(0x00, 0x90, 0x00), RGB_TYPE(0x00, 0xA8, 0x00), RGB_TYPE(0x00, 0x90, 0x38), RGB_TYPE(0x00, 0x80, 0x88), RGB_TYPE(0x00, 0x00, 0x00), RGB_TYPE(0x00, 0x00, 0x00), RGB_TYPE(0x00, 0x00, 0x00), 
	RGB_TYPE(0xF8, 0xF8, 0xF8), RGB_TYPE(0x38, 0xB8, 0xF8), RGB_TYPE(0x58, 0x90, 0xF8), RGB_TYPE(0x40, 0x88, 0xF8), RGB_TYPE(0xF0, 0x78, 0xF8), RGB_TYPE(0xF8, 0x70, 0xB0), RGB_TYPE(0xF8, 0x70, 0x60), RGB_TYPE(0xF8, 0x98, 0x38), 
	RGB_TYPE(0xF0, 0xB8, 0x38), RGB_TYPE(0x80, 0xD0, 0x10), RGB_TYPE(0x48, 0xD8, 0x48), RGB_TYPE(0x58, 0xF8, 0x98), RGB_TYPE(0x00, 0xE8, 0xD8), RGB_TYPE(0x00, 0x00, 0x00), RGB_TYPE(0x00, 0x00, 0x00), RGB_TYPE(0x00, 0x00, 0x00), 
	RGB_TYPE(0xF8, 0xF8, 0xF8), RGB_TYPE(0xA8, 0xE0, 0xF8), RGB_TYPE(0xC0, 0xD0, 0xF8), RGB_TYPE(0xD0, 0xC8, 0xF8), RGB_TYPE(0xF8, 0xC0, 0xF8), RGB_TYPE(0xF8, 0xC0, 0xD8), RGB_TYPE(0xF8, 0xB8, 0xB0), RGB_TYPE(0xF8, 0xD8, 0xA8), 
	RGB_TYPE(0xF8, 0xE0, 0xA0), RGB_TYPE(0xE0, 0xF8, 0xA0), RGB_TYPE(0xA8, 0xF0, 0xB8), RGB_TYPE(0xB0, 0xF8, 0xC8), RGB_TYPE(0x98, 0xF8, 0xF0), RGB_TYPE(0x00, 0x00, 0x00), RGB_TYPE(0x00, 0x00, 0x00), RGB_TYPE(0x00, 0x00, 0x00), 
#endif
};

const DWORD NesPaletteRGB888[ 64 ] =
{
	RGBA8888(0x70, 0x70, 0x70), RGBA8888(0x20, 0x18, 0x88), RGBA8888(0x00, 0x00, 0xA8), RGBA8888(0x40, 0x00, 0x98), RGBA8888(0x88, 0x00, 0x70), RGBA8888(0xA8, 0x00, 0x10), RGBA8888(0xA0, 0x00, 0x00), RGBA8888(0x78, 0x08, 0x00),
	RGBA8888(0x40, 0x28, 0x00), RGBA8888(0x00, 0x40, 0x00), RGBA8888(0x00, 0x50, 0x00), RGBA8888(0x00, 0x38, 0x10), RGBA8888(0x18, 0x38, 0x58), RGBA8888(0x00, 0x00, 0x00), RGBA8888(0x00, 0x00, 0x00), RGBA8888(0x00, 0x00, 0x00),
	RGBA8888(0xB8, 0xB8, 0xB8), RGBA8888(0x00, 0x70, 0xE8), RGBA8888(0x20, 0x38, 0xE8), RGBA8888(0x80, 0x00, 0xF0), RGBA8888(0xB8, 0x00, 0xB8), RGBA8888(0xE0, 0x00, 0x58), RGBA8888(0xD8, 0x28, 0x00), RGBA8888(0xC8, 0x48, 0x08),
	RGBA8888(0x88, 0x70, 0x00), RGBA8888(0x00, 0x90, 0x00), RGBA8888(0x00, 0xA8, 0x00), RGBA8888(0x00, 0x90, 0x38), RGBA8888(0x00, 0x80, 0x88), RGBA8888(0x00, 0x00, 0x00), RGBA8888(0x00, 0x00, 0x00), RGBA8888(0x00, 0x00, 0x00),
	RGBA8888(0xF8, 0xF8, 0xF8), RGBA8888(0x38, 0xB8, 0xF8), RGBA8888(0x58, 0x90, 0xF8), RGBA8888(0x40, 0x88, 0xF8), RGBA8888(0xF0, 0x78, 0xF8), RGBA8888(0xF8, 0x70, 0xB0), RGBA8888(0xF8, 0x70, 0x60), RGBA8888(0xF8, 0x98, 0x38),
	RGBA8888(0xF0, 0xB8, 0x38), RGBA8888(0x80, 0xD0, 0x10), RGBA8888(0x48, 0xD8, 0x48), RGBA8888(0x58, 0xF8, 0x98), RGBA8888(0x00, 0xE8, 0xD8), RGBA8888(0x00, 0x00, 0x00), RGBA8888(0x00, 0x00, 0x00), RGBA8888(0x00, 0x00, 0x00),
	RGBA8888(0xF8, 0xF8, 0xF8), RGBA8888(0xA8, 0xE0, 0xF8), RGBA8888(0xC0, 0xD0, 0xF8), RGBA8888(0xD0, 0xC8, 0xF8), RGBA8888(0xF8, 0xC0, 0xF8), RGBA8888(0xF8, 0xC0, 0xD8), RGBA8888(0xF8, 0xB8, 0xB0), RGBA8888(0xF8, 0xD8, 0xA8),
	RGBA8888(0xF8, 0xE0, 0xA0), RGBA8888(0xE0, 0xF8, 0xA0), RGBA8888(0xA8, 0xF0, 0xB8), RGBA8888(0xB0, 0xF8, 0xC8), RGBA8888(0x98, 0xF8, 0xF0), RGBA8888(0x00, 0x00, 0x00), RGBA8888(0x00, 0x00, 0x00), RGBA8888(0x00, 0x00, 0x00),
};
/* RAM */
 ...
 */
  ...
  for ( nIdx = 0; nIdx < SCAN_VBLANK_START; ++nIdx )
  {
 ...
 */
  ...
  LOGV("MapperNo = MapperTable[%d] = %d", nIdx, MapperNo);
...
//	InfoNES_Init();
	...
	// Main loop
	while ( InfoNES_QuitFlag() == 0 )
	{  
		if( 0 == (cnt++ & 0x007fff)  ){
			//LOGV("InfoNES_Main loop %d", cnt>>15);
		}
		/*-------------------------------------------------------------------*/
...
//		PPU_Addr = PPU_Temp;
	...
	for (;;)
	{
		...
		for (PPU_Scanline = SCAN_TOP_OFF_SCREEN_START;
				PPU_Scanline < SCAN_UNKNOWN_START;
				PPU_Scanline++, 
					pPointTop += NES_DISP_WIDTH, 
...
//				pPoint = &WorkFrame[ PPU_Scanline * NES_DISP_WIDTH ];
				...
				{
#ifdef NES_WORKFRAME_SLIM
					InfoNES_MemorySet( pPoint, 0, NES_DISP_WIDTH );
#else
...
//						pPointTop = &WorkFrame[ PPU_Scanline * NES_DISP_WIDTH ];
#ifdef NES_WORKFRAME_SLIM
						InfoNES_MemorySet( pPointTop, 0, 8);
#else
					...
					{
//						TRACE2("[L %3d] PPU_R1 = %3X", PPU_Scanline, PPU_R1 );
						...
						for ( nX = 0; nX < NES_DISP_WIDTH; ++nX )
						{
							nSprData = pSprBuf[ nX ];
#ifdef NES_WORKFRAME_SLIM
							if ( nSprData  && ( nSprData & 0x80 || pPoint[ nX ] & 0x80/*0x8000*/ ) )
#else
							if ( nSprData  && ( nSprData & 0x80 || pPoint[ nX ] & SPR_FLAG_BIT ) )
#endif
							{
...
//							pPointTop = &WorkFrame[ PPU_Scanline * NES_DISP_WIDTH ];
		...
		PPU_Scanline = SCAN_VBLANK_START; // 243
		if ( FrameCnt == 0 )
		{
		...
		PPU_Scanline = SCAN_VBLANK_END; // 263; // 243
		{
			// FrameCnt + 1
...
//			if ( !APU_Mute )
			...
			if ( PAD_PUSH( PAD_System, PAD_SYS_QUIT ) )
				continue; // return -1;  // Exit an emulation
		}
		// Execute instructions
		K6502_Step( STEP_PER_SCANLINE );

		PPU_Scanline = SCAN_TOP_OFF_SCREEN_START; // 0;
		{
			PPU_R2 = 0;
...
#elif defined( NES_OPITIM_2 )
/*===================================================================*/
/*                                                                   */
/*              InfoNES_Step() : step 1 in InfoNES_Cycle()             */
/*                                                                   */
/*===================================================================*/
 ...
 */
  ...
  if ( ( PPU_R1 & R1_SHOW_SP ) || ( PPU_R1 & R1_SHOW_SCR ) )
	...
	for (;;)
	{
    	...
    	// Set a flag if a scanning line is a hit in the sprite #0
		PPU_Scanline = 0;
		while( PPU_Scanline < SCAN_UNKNOWN_START )
		{
			if ( SpriteJustHit == PPU_Scanline &&
				 PPU_ScanTable[ PPU_Scanline ] == SCAN_ON_SCREEN )
			{
		...
		while( PPU_Scanline < SCAN_VBLANK_START )
		{
/*
			if ( SpriteJustHit == PPU_Scanline &&
				 PPU_ScanTable[ PPU_Scanline ] == SCAN_ON_SCREEN )
...
/*                                                                   */
/*===================================================================*/
//extern void InfoNesDrawBlock(int Scanline, unsigned short *buf);
...
#else // #elif defined( NES_OPTIM_3 = NO OPTIM )
/*===================================================================*/
/*                                                                   */
/*              InfoNES_Cycle() : The loop of emulation              */
/*                                                                   */
 ...
 */
  ...
  // Emulation loop
//	LOGV("InfoNES_Cycle()  in loop NES_OPITIM_3");
	// Emulation loop
//	for (;;)
//	while(InfoNES_QuitFlag() == 0)
	{
...
void InfoNES_GetSRAMData(struct SRAM_DATA *pSramData)
{
	...
	K6502_GetReg( &(pSramData->K6502_REG) );
	/* RAM */
	memcpy( pSramData->RAM, RAM, sizeof(RAM) );
	/* SRAM */
	memcpy( pSramData->SRAM, SRAM, sizeof(SRAM) );
	/*-------------------------------------------------------------------*/
	/*  PPU resources                                                    */
	/*-------------------------------------------------------------------*/
	/* PPU RAM */
	memcpy( pSramData->PPURAM, PPURAM, sizeof(PPURAM) );
	/* Sprite RAM */
	memcpy( pSramData->SPRRAM, SPRRAM, sizeof(SPRRAM) );
	for(k=0 ; k<16 ; k++)
	{
		pSramData->PPUBANK[k] = (WORD)(PPUBANK[k] - PPURAM);
	}
	/* PPU Register */
	pSramData->PPU_R0 = PPU_R0;
	pSramData->PPU_R1 = PPU_R1;
	pSramData->PPU_R2 = PPU_R2;
	pSramData->PPU_R3 = PPU_R3;
	pSramData->PPU_R7 = PPU_R7;
	/* Vertical scroll value */
#if 0
	pSramData->PPU_Scr_V = PPU_Scr_V;
	pSramData->PPU_Scr_V_Next = PPU_Scr_V_Next;
	pSramData->PPU_Scr_V_Byte = PPU_Scr_V_Byte;
	pSramData->PPU_Scr_V_Byte_Next = PPU_Scr_V_Byte_Next;
	pSramData->PPU_Scr_V_Bit = PPU_Scr_V_Bit;
	pSramData->PPU_Scr_V_Bit_Next = PPU_Scr_V_Bit_Next;
	/* Horizontal scroll value */
	pSramData->PPU_Scr_H = PPU_Scr_H;
	pSramData->PPU_Scr_H_Next = PPU_Scr_H_Next;
	pSramData->PPU_Scr_H_Byte = PPU_Scr_H_Byte;
	pSramData->PPU_Scr_H_Byte_Next = PPU_Scr_H_Byte_Next;
	pSramData->PPU_Scr_H_Bit = PPU_Scr_H_Bit;
	pSramData->PPU_Scr_H_Bit_Next = PPU_Scr_H_Bit_Next;
	/* PPU Address */
#endif
	pSramData->PPU_Addr = PPU_Addr;
	/* PPU Address */
	pSramData->PPU_Temp = PPU_Temp;
	/* The increase value of the PPU Address */
	pSramData->PPU_Increment = PPU_Increment;
	/* Current Scanline */
	pSramData->PPU_Scanline = PPU_Scanline;
	/* Scanline Table */
	memcpy( pSramData->PPU_ScanTable, PPU_ScanTable, sizeof(PPU_ScanTable));
	/* Name Table Bank */
	pSramData->PPU_NameTableBank = PPU_NameTableBank;
	pSramData->PPU_BG_Base = (WORD)(PPU_BG_Base - ChrBuf);
	pSramData->PPU_SP_Base = (WORD)(PPU_SP_Base - ChrBuf);
	/* Sprite Height */
	pSramData->PPU_SP_Height = PPU_SP_Height;
	/* Sprite #0 Scanline Hit Position */
	pSramData->SpriteJustHit = SpriteJustHit;
	/* VRAM Write Enable ( 0: Disable, 1: Enable ) */
	pSramData->byVramWriteEnable = byVramWriteEnable;
	/* PPU Address and Scroll Latch Flag*/
	pSramData->PPU_Latch_Flag = PPU_Latch_Flag;
	/* Up and Down Clipping Flag ( 0: non-clip, 1: clip ) */
	pSramData->PPU_UpDown_Clip = PPU_UpDown_Clip;
	/* Frame IRQ ( 0: Disabled, 1: Enabled )*/
	pSramData->FrameIRQ_Enable = FrameIRQ_Enable;
	pSramData->FrameStep = FrameStep;
	/*-------------------------------------------------------------------*/
	/*  Display and Others resouces                                      */
	/*-------------------------------------------------------------------*/
	/* Display Buffer */
	memcpy( pSramData->WorkFrame, WorkFrame, sizeof(WorkFrame));
	/* Character Buffer */
	memcpy( pSramData->ChrBuf, ChrBuf, sizeof(ChrBuf));
	/* Update flag for ChrBuf */
	pSramData->ChrBufUpdate = ChrBufUpdate;
	memcpy( pSramData->PalTable, PalTable, sizeof(PalTable));
	/*-------------------------------------------------------------------*/
	/*  APU and Pad resources                                            */
	/*-------------------------------------------------------------------*/
	/* APU Register */
	memcpy( pSramData->APU_Reg, APU_Reg, sizeof(APU_Reg));
}
...
void InfoNES_SetSRAMData(struct SRAM_DATA *pSramData)
{
	...
	K6502_SetReg( &(pSramData->K6502_REG) );
	/* RAM */
	memcpy( RAM, pSramData->RAM, sizeof(RAM) );
	/* SRAM */
	memcpy( SRAM, pSramData->SRAM, sizeof(SRAM) );
	/*-------------------------------------------------------------------*/
	/*  PPU resources                                                    */
	/*-------------------------------------------------------------------*/
	/* PPU RAM */
	memcpy( PPURAM, pSramData->PPURAM, sizeof(PPURAM) );
	/* Sprite RAM */
	memcpy( SPRRAM, pSramData->SPRRAM, sizeof(SPRRAM) );
	for(k=0 ; k<16 ; k++)
	{
		PPUBANK[k] = pSramData->PPUBANK[k] + PPURAM;
	}

	/* PPU Register */
	PPU_R0 = pSramData->PPU_R0;
	PPU_R1 = pSramData->PPU_R1;
	PPU_R2 = pSramData->PPU_R2;
	PPU_R3 = pSramData->PPU_R3;
	PPU_R7 = pSramData->PPU_R7;
	/* Vertical scroll value */
#if 0
	PPU_Scr_V = pSramData->PPU_Scr_V;
	PPU_Scr_V_Next = pSramData->PPU_Scr_V_Next;
	PPU_Scr_V_Byte = pSramData->PPU_Scr_V_Byte;
	PPU_Scr_V_Byte_Next = pSramData->PPU_Scr_V_Byte_Next;
	PPU_Scr_V_Bit = pSramData->PPU_Scr_V_Bit;
	PPU_Scr_V_Bit_Next = pSramData->PPU_Scr_V_Bit_Next;
	/* Horizontal scroll value */
	PPU_Scr_H = pSramData->PPU_Scr_H;
	PPU_Scr_H_Next = pSramData->PPU_Scr_H_Next;
	PPU_Scr_H_Byte = pSramData->PPU_Scr_H_Byte;
	PPU_Scr_H_Byte_Next = pSramData->PPU_Scr_H_Byte_Next;
	PPU_Scr_H_Bit = pSramData->PPU_Scr_H_Bit;
	PPU_Scr_H_Bit_Next = pSramData->PPU_Scr_H_Bit_Next;
#endif
	/* PPU Address */
	PPU_Addr = pSramData->PPU_Addr;
	/* PPU Address */
	PPU_Temp = pSramData->PPU_Temp;
	/* The increase value of the PPU Address */
	PPU_Increment = pSramData->PPU_Increment;
	/* Current Scanline */
	PPU_Scanline = pSramData->PPU_Scanline;
	/* Scanline Table */
	memcpy( PPU_ScanTable, pSramData->PPU_ScanTable, sizeof(PPU_ScanTable));
	/* Name Table Bank */
	PPU_NameTableBank = pSramData->PPU_NameTableBank;
	PPU_BG_Base = ChrBuf + pSramData->PPU_BG_Base;
	PPU_SP_Base = ChrBuf + pSramData->PPU_SP_Base;
	/* Sprite Height */
	PPU_SP_Height = pSramData->PPU_SP_Height;
	/* Sprite #0 Scanline Hit Position */
	SpriteJustHit = pSramData->SpriteJustHit;
	/* VRAM Write Enable ( 0: Disable, 1: Enable ) */
	byVramWriteEnable = pSramData->byVramWriteEnable;
	/* PPU Address and Scroll Latch Flag*/
	PPU_Latch_Flag = pSramData->PPU_Latch_Flag;
	/* Up and Down Clipping Flag ( 0: non-clip, 1: clip ) */
	PPU_UpDown_Clip = pSramData->PPU_UpDown_Clip;
	/* Frame IRQ ( 0: Disabled, 1: Enabled )*/
//	FrameIRQ_Enable = pSramData->FrameIRQ_Enable;
	FrameStep = pSramData->FrameStep;
	...
	/*-------------------------------------------------------------------*/
	/* Display Buffer */
	memcpy( WorkFrame, pSramData->WorkFrame, sizeof(WorkFrame));
	/* Character Buffer */
	memcpy( ChrBuf, pSramData->ChrBuf, sizeof(ChrBuf));
	/* Update flag for ChrBuf */
	ChrBufUpdate = pSramData->ChrBufUpdate;
	memcpy( PalTable, pSramData->PalTable, sizeof(PalTable));
	/*-------------------------------------------------------------------*/
	/*  APU and Pad resources                                            */
	/*-------------------------------------------------------------------*/
	/* APU Register */
	memcpy( APU_Reg, pSramData->APU_Reg, sizeof(APU_Reg));
