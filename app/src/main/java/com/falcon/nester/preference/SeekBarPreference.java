...
implements OnSeekBarChangeListener
{
    ...
    private void updateValuesFromXml(AttributeSet attrs) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, SEEKBAR_PREFS, "unitsLeft", String.valueOf(mMinValue));
        String value = getAttributeStringValue(attrs, SEEKBAR_PREFS, "value", "");
        mUnitsRight = getAttributeStringValue(attrs, SEEKBAR_PREFS, "unitsRight", String.valueOf(mMaxValue));
